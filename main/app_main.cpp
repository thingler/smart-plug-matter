...
extern "C" void app_main()
{
    ...
    /* Initialize driver */
    app_driver_handle_t plug_handle = app_driver_power_init();
    ...
    endpoint_t *endpoint = on_off_plugin_unit::create(node, &on_off_plugin_unit_config, ENDPOINT_FLAG_NONE, plug_handle);
    ...
    app_driver_power_set_defaults(plug_endpoint_id);
